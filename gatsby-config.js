...
const domainConfigs = {
  'unitz.biz': require('./domains/unitz.biz/gatsby-config'),
  'unitz.it': require('./domains/unitz.it/gatsby-config'),
};

const targetDomain = _.get(domainConfigs, process.env.GATSBY_TARGET_DOMAIN || 'unitz.biz') || {};
